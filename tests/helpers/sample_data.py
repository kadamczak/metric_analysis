...
multiclass_1 = SampleData(probs=probs1,
...
multiclass_2 = SampleData(probs=probs2,
...
########################################################
## 3 MULTICLASS, IMBALANCED, 0 TRUE SAMPLES IN CLASS 1
########################################################
...
multiclass_3 = SampleData(probs=probs3,
...
multiclass_4 = SampleData(probs=probs4,
...
########################################################
## 5 MULTICLASS, IMBALANCED, 0 TRUE SAMPLES AND PREDICTIONS IN CLASS 1
########################################################
...
multiclass_5 = SampleData(probs=probs5,
...
binary_6 = SampleData(probs=probs6,
...
binary_7 = SampleData(probs=probs7,
