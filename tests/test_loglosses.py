...
class TestLogLoss(MetricTestBase):
    def setUp(self):
        self.metric_name = "logloss"
        self.multiclass_metric_calculator = LogLoss(num_classes=3)
        self.binary_metric_calculator = LogLoss(num_classes=2)
